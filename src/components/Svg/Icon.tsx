...
const IconArrowRight = (props: propsT) => {
  ...
  // 保持原始宽高比 16:27
  const height = Math.round(size * 27 / 16);
  return (
    <svg
      width={size}
      height={height}
...
const IconPhoneCall  = (props: propsT) => {
  return (
    <svg 
        width="20px" 
        height="20px"
