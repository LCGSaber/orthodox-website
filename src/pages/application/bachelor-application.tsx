...
import HongKongBachelorApply from 'src/components/PageHome/HongKongBachelorApply'
...
const ApplicationInternationalScool = () => {
  ...
  return (
    ...
    <LittleMenu text1={g(homepage,'home')} link1='/' text2={g(homepage,'application_un')}/>
    <HongKongBachelorApply/>
